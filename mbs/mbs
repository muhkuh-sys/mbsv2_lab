...
JONCHKI_VERSION=0.0.9.1
HOST_REPOSITORY=~/.mbs2
...
ARTIFACT_REPOSITORY_PATH=$(realpath ${HOST_REPOSITORY})/repository/org/muhkuh/lua/jonchki/${JONCHKI_VERSION}
ARTIFACT_INSTALL_PATH=$(realpath ${HOST_REPOSITORY})/install/org/muhkuh/lua/jonchki
...
# Run jonchki.
${JONCHKI_TOOL} install-dependencies --verbose WARNING --syscfg mbs/jonchki/jonchkisys.cfg --prjcfg mbs/jonchki/jonchkicfg.xml --dependency-log mbs/jonchki/dependency-log.xml --logfile targets/jonchki/jonchki.log mbs/jonchki/mbs.xml
